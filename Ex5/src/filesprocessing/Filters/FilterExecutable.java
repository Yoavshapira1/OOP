...
public class FilterExecutable extends Filter {
     ...
     */
    public FilterExecutable(String[] parameters) throws Type1Exception {
    ...
    public boolean accept(File pathname) {
        if (pathname != null) {
            return (Files.isExecutable(pathname.toPath()) == this.yesOrNo) != isNOTon && (pathname.isFile());
        }
        return false;
    }
}
