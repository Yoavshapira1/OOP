...
/** Filter all files with size smaller than a given number of KB. */
public class FilterSmallerThan extends Filter {
     ...
     */
    public FilterSmallerThan(String[] parameters) throws NullPointerException, NumberFormatException, Type1Exception {
