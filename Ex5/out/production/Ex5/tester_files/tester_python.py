...
path_to_DirectoryProcessor_compiled = path.join("filesprocessing.filesprocessing.DirectoryProcessor")
...
def run_one_test(test_folder_name, files_to_filter_folder):
    ...
    if compare_outputs is not None or compare_errors is not None:
        ...
        if compare_errors is not None:
            print("filesprocessing.Errors file compare failed: here are the details:")
